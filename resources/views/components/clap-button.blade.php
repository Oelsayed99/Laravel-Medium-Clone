...
@auth
 <div x-data='{
    hasClapped: @json(auth()->user()->hasClapped($post)),
    count: @json($post->claps()->count()),
    clap() {
    ...
    <button class="text-gray-500 hover:text-gray-700 focus:outline-none flex gap-2" @click="clap">
